...
const FloatingMenu = () => {
  ...
  return (
    <motion.nav
      ...
      className="fixed top-4 sm:top-8 left-1/2 -translate-x-1/2 md:left-auto md:translate-x-0 md:right-8 z-50 h-10 sm:h-12 px-3 sm:px-6 rounded-full bg-glass backdrop-blur-md shadow-2xl flex items-center justify-center gap-2 sm:gap-6"
